...
var G__9964 = devtools.prefs.pref.call(null,v);
v = G__9964;
continue;
} else {
return v;
...
var and__5729__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__5729__auto__){
var and__5729__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__5741__auto__ = (function (){try{if(!((value == null))){
...
}catch (e9977){var e__7617__auto__ = e9977;
return false;
}})();
if(cljs.core.truth_(or__5741__auto__)){
return or__5741__auto__;
} else {
var or__5741__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e9981){var e__7617__auto__ = e9981;
return false;
}})();
...
}catch (e9983){var e__7617__auto__ = e9983;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__5729__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__5729__auto__)){
var and__5729__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__5729__auto____$1){
...
var and__5729__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__5729__auto__)){
...
var or__5741__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__5741__auto__)){
return or__5741__auto__;
} else {
...
var and__5729__auto__ = (function (){var or__5741__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__5741__auto__)){
return or__5741__auto__;
} else {
...
var vec__9988 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9988,(0),null);
var name = cljs.core.nth.call(null,vec__9988,(1),null);
...
var and__5729__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__5729__auto__)){
...
var or__5741__auto__ = typeof value === 'string';
if(or__5741__auto__){
return or__5741__auto__;
} else {
var or__5741__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__9991_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9991_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1476331711777