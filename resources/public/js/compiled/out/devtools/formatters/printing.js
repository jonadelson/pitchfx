...
var len__6816__auto___10005 = arguments.length;
var i__6817__auto___10006 = (0);
while(true){
if((i__6817__auto___10006 < len__6816__auto___10005)){
args__6823__auto__.push((arguments[i__6817__auto___10006]));

var G__10007 = (i__6817__auto___10006 + (1));
i__6817__auto___10006 = G__10007;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__6824__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq10002){
var G__10003 = cljs.core.first.call(null,seq10002);
var seq10002__$1 = cljs.core.next.call(null,seq10002);
var G__10004 = cljs.core.first.call(null,seq10002__$1);
var seq10002__$2 = cljs.core.next.call(null,seq10002__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__10003,G__10004,seq10002__$2);
});
...
if(cljs.core.truth_((function (){var or__5741__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__6347__auto__,writer__6348__auto__,opt__6349__auto__){
return cljs.core._write.call(null,writer__6348__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__5729__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__5729__auto__){
var or__5741__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__5741__auto__)){
return or__5741__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__10008_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__10008_SHARP_));
})))){
...
var map__10017 = opts;
var map__10017__$1 = ((((!((map__10017 == null)))?((((map__10017.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10017.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10017):map__10017);
var markup_db = cljs.core.get.call(null,map__10017__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__5741__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e10021){var e__7617__auto__ = e10021;
return false;
}})();
if(cljs.core.truth_(or__5741__auto__)){
return or__5741__auto__;
...
}catch (e10023){var e__7617__auto__ = e10023;
return false;
}}
})())){
...
var _STAR_current_state_STAR_10028 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__10029 = opts;
...
var markup_db = cljs.core.get.call(null,map__10029__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_10028;
}});
...
;
var temp__4655__auto___10034 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___10034)){
var managed_print_level_10035 = temp__4655__auto___10034;
var _STAR_print_level_STAR_10033_10036 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_10035;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_10033_10036,managed_print_level_10035,temp__4655__auto___10034,writer,opts,job_fn){
return (function (p1__10031_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__10031_SHARP_,null);
});})(_STAR_print_level_STAR_10033_10036,managed_print_level_10035,temp__4655__auto___10034,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_10033_10036;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1476331712020