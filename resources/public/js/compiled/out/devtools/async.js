...
var o__7592__auto___17765 = (function (){var o__7592__auto__ = (function (){var o__7592__auto__ = Promise;
return goog.object.get(o__7592__auto__,"resolve").call(o__7592__auto__);
})();
return goog.object.get(o__7592__auto__,"then").call(o__7592__auto__,callback);
})();
goog.object.get(o__7592__auto___17765,"catch").call(o__7592__auto___17765,devtools.async.rethrow_outside_promise);
...
var G__17767_17768 = Error;
var target__7611__auto___17769 = G__17767_17768;
if(cljs.core.truth_(target__7611__auto___17769)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__17767_17768)].join('')),cljs.core.str("\n"),cljs.core.str("target__7611__auto__")].join('')));
}

goog.object.set(target__7611__auto___17769,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1476331731332