...
var vec__15496_15499 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_15500 = cljs.core.nth.call(null,vec__15496_15499,(0),null);
var only_after_15501 = cljs.core.nth.call(null,vec__15496_15499,(1),null);
var db_changed_QMARK__15502 = (cljs.core.some_QMARK_.call(null,only_before_15500)) || (cljs.core.some_QMARK_.call(null,only_after_15501));
if(db_changed_QMARK__15502){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_15500);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_15501);
...
var map__15509 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__15509__$1 = ((((!((map__15509 == null)))?((((map__15509.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15509.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15509):map__15509);
var db = cljs.core.get.call(null,map__15509__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__15509__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__15517 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__15517__$1 = ((((!((map__15517 == null)))?((((map__15517.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15517.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15517):map__15517);
var coeffects = map__15517__$1;
var event = cljs.core.get.call(null,map__15517__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__6816__auto___15520 = arguments.length;
var i__6817__auto___15521 = (0);
while(true){
if((i__6817__auto___15521 < len__6816__auto___15520)){
args__6823__auto__.push((arguments[i__6817__auto___15521]));

var G__15522 = (i__6817__auto___15521 + (1));
i__6817__auto___15521 = G__15522;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__6824__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq15519){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq15519));
});
...
var args__6823__auto__ = [];
var len__6816__auto___15528 = arguments.length;
var i__6817__auto___15529 = (0);
while(true){
if((i__6817__auto___15529 < len__6816__auto___15528)){
args__6823__auto__.push((arguments[i__6817__auto___15529]));

var G__15530 = (i__6817__auto___15529 + (1));
i__6817__auto___15529 = G__15530;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__6824__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__15523_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__15524_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__15524_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq15525){
var G__15526 = cljs.core.first.call(null,seq15525);
var seq15525__$1 = cljs.core.next.call(null,seq15525);
var G__15527 = cljs.core.first.call(null,seq15525__$1);
var seq15525__$2 = cljs.core.next.call(null,seq15525__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__15526,G__15527,seq15525__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1476331720969