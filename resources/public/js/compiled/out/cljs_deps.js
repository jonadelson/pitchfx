...
goog.addDependency("../pitchfx/db.js", ['pitchfx.db'], ['cljs.core']);
...
goog.addDependency("../pitchfx/handlers.js", ['pitchfx.handlers'], ['reagent.core', 'cljs.core', 'cljs_http.client', 'cljs.core.async', 'pitchfx.db', 'cljs.reader', 're_frame.core']);
goog.addDependency("../pitchfx/subs.js", ['pitchfx.subs'], ['cljs.core', 're_frame.core']);
...
goog.addDependency("../pitchfx/charts.js", ['pitchfx.charts'], ['re_com.text', 'goog.string', 're_com.box', 'reagent.core', 'cljs.core', 'goog.string.format', 're_frame.core', 'cljsjs.d3']);
goog.addDependency("../object-assign-shim.inc.js", ['cljsjs.object_assign_shim'], []);
goog.addDependency("../fixed-data-table.inc.js", ['cljsjs.fixed_data_table'], ['cljsjs.react', 'cljsjs.object_assign_shim']);
goog.addDependency("../pitchfx/data_table.js", ['pitchfx.data_table'], ['reagent.core', 'cljs.core', 'cljsjs.fixed_data_table', 're_frame.core']);
goog.addDependency("../pitchfx/views.js", ['pitchfx.views'], ['re_com.core', 'pitchfx.charts', 're_com.text', 're_com.box', 'cljs.core', 're_com.typeahead', 're_com.tabs', 'pitchfx.data_table', 'clojure.string', 're_com.dropdown', 're_com.misc', 're_frame.core']);
goog.addDependency("../pitchfx/config.js", ['pitchfx.config'], ['cljs.core']);
...
goog.addDependency("../pitchfx/core.js", ['pitchfx.core'], ['pitchfx.handlers', 'reagent.core', 'cljs.core', 'cljs_http.client', 'pitchfx.subs', 'cljs.core.async', 'pitchfx.views', 'pitchfx.config', 'devtools.core', 'cljs.reader', 're_frame.core']);
